...
<br>
	<form action="./regist" method="post" name="joinform">
		...
		<div>
			...
			<div>
			<tr>
<!-- 				<td><input class="submit" type="button" value="가입하기" onclick="finalCheck()"></td> -->
        ...
        <div class="regist">
            ...
            <div class="regist_id">
             ...
             <div class="login_etc"> 
                 <p style="text-align:right;"><input type="button" value="중복확인" onclick="IdCheck()" required="required"><p>
            </div>
            <td><input type="text" name="memberId" id="memberId" readonly="readonly"></td>
				<td><input type="button" value="중복확인" onclick="IdCheck()" required="required"></td>
            </div>
            <div class="regist_pw">
                <h4>Password</h4>
                <input type="password" name="memberPwd" id="memberPwd" required="required">
            </div>
            <div class="regist_pw">
	            ...
	            <br>
	            <br>
	            <div id="checkerPwd">동일한 암호를 입력하세요.</div>
            </div>
            <div class="submit">
                <input type="submit" value="가입하기" onclick="finalCheck()">
            </div>
        </div>
    </div> -->
</body>
