                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <h2 class="section-heading mb-4">하나. 식물을 키워본 경험이 있으신가요?</h2><br>
                                ...
                                <div class="carousel-item">
                                    <h2 class="section-heading mb-4">둘. 외출을 선호하시나요?</h2><br>
                                ...
                                <div class="carousel-item">
                                    <h2 class="section-heading mb-4">셋. 세심하고 꼼꼼한 성격인가요?</h2><br>
                                ...
                                <div class="carousel-item">
                                    <h2 class="section-heading mb-4">넷. 반려동물을 키우고 있나요?</h2><br>
                                ...
                                <div class="carousel-item">
                                    <h2 class="section-heading mb-4">다섯. 식물을 키우려는 곳의 빛은 어느정도 인가요?</h2><br>
                                ...
                                <div class="carousel-item">
                                    <h2 class="section-heading mb-4">여섯. 잎보기 식물과 꽃보기 식물 중 어느 것을 더 선호하나요?</h2><br>
                                ...
                                <div class="carousel-item">
                                    <h2 class="section-heading mb-4">일곱. 식물을 키우려는 곳의 평상시 온도는 어느 정도 인가요?</h2><br>
                                ...
                                <div class="carousel-item">
                                    <h2 class="section-heading mb-4">여덟. 식물을 키우려는 곳의 겨울 최저 온도는 어느 정도 인가요?</h2><br>
                                ...
                                <div class="carousel-item">
                                    <h2 class="section-heading mb-4">아홉. 식물을 키우려는 곳의 습도는 어느 정도 인가요?</h2><br>
