...
<div id="waterdiv" class="pushdiv"
    ...
    <form action="/myplants/${myplantId}/schedule/push" method="post">
        ...
        <p style="text-align: center; font-family: 'KimjungchulGothic-Bold'; font-size: 12px">*모바일 기기로 사이트 접속후 알람권한을 설정하시면 모바일로도 알람이 발송됩니다. </p>
        ...
        <div style="text-align: center;">
            ...
            <p class="information">화분에 손가락을 2~3cm 찔러 넣었을 때 흙이 말라있다면 물을 줄 시기에요.<br>
                ...
                상세페이지의 '계절별 물 주는 시기' 정보를 참고하여 상황에 맞게 주기를 고르시면 되요.<br><br><br>
            </p>
...
<div id="drugdiv" class="pushdiv"
    ...
    <form action="/myplants/${myplantId}/schedule/push2" method="post">
        ...
        <div style="text-align: center;">
            ...
            <br>
            <br>
            <p class="information">씨앗 발아 단계: 건강한 뿌리 발달을 도와줄 포타슘이 풍부한 영양제를 추천드려요.<br>

                초창기 성장 단계: 식물이 빠르게 성장하면서 많은 영양소를 필요로 합니다. 질소 함량이 높은 영양제를 추천드려요. <br>

                꽃봉오리 형성 단계: 인산 함유 영양제를 추천드려요. 인산은 식물의 에너지 전달을 돕고, 꽃봉오리의 형성과 개화를 촉진합니다.<br>

                개화 및 열매 단계: 포타슘이 풍부한 영양제를 추천드려요. 포타슘은 식물의 수분 균형을 유지하는 데 도움이 됩니다.<br><br><br>
            </p>
...
<div id="cutdiv" class="pushdiv"
    ...
    <form action="/myplants/${myplantId}/schedule/push3" method="post">
        ...
        <div style="text-align: center;">
            ...
            <br>
            <br>
            <p class="information">가지치기는 식물이 적극적인 성장기에 하는 것이 가장 좋습니다.<br>
                가지를 잘라낼 때는 항상 깨끗하고 날카로운 도구를 사용하세요.<br>
                각 가지를 식물의 베이스와 가까운 부분에서 잘라내야 합니다.<br>
                가지치기 후에는 식물을 잘 관리하고 충분한 물을 주어야 합니다.<br><br><br>
            </p>
